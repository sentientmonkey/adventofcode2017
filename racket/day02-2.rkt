...
(module+ test
  (require rackunit)
  [check-equal? (row-checksum '(5 9 2 8)) 4]
  [check-equal? (row-checksum '(9 4 7 3)) 3]
  [check-equal? (row-checksum '(3 8 6 5)) 2]
  [check-equal? (column-checksum '((5 9 2 8)
                                   (9 4 7 3)
                                   (3 8 6 5))) 9]
  [check-equal? (parse-spreadsheet "1\t2\t3\n4\t5\t6\n")
                '((1 2 3)
                  (4 5 6))])
